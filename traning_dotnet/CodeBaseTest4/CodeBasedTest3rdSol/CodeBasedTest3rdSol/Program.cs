    ...
    class Program
    {
        static void Main()
        {
           List<Employee> empList = new List<Employee>
           {
            ...
            {
                Console.WriteLine($"EmployeID:{emp.EmployeeID},FirstName:{emp.FirstName},LastName:{emp.LastName},Title:{emp.Title},DateOfBirth:{emp.DOB},DateOfJoining:{emp.DOJ}");

            }
            var mumbaiEmployees = from emp in empList
                                    where emp.City == "Mumbai"
                                    select emp;
            Console.WriteLine("\n Employees from Mumbai:");
            foreach (var emp in mumbaiEmployees)
            {
                Console.WriteLine($"EmployeID:{emp.EmployeeID},FirstName:{emp.FirstName},LastName:{emp.LastName},Title:{emp.Title},DateOfBirth:{emp.DOB},DateOfJoining:{emp.DOJ}");
            }
